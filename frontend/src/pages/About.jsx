            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12 texy-black capitalize ">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="text-body-color mb-8 text-base">
                  Welcome to our academic portal! We are passionate about
                  education and providing a platform for students and teachers
                  to connect, learn, and grow together. Our mission is to make
                  learning accessible and enjoyable for everyone, regardless of
                  their background or location. Join us on this journey as we
                  strive to empower minds and inspire futures.
                </p>
              </div>
            </div>
          </div>
